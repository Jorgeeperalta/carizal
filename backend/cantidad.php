...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO `cantidad_ganado` (`pk_cantidad_ganado`, `cantidad`, `fk_categoria_ganado`, `fk_ambiente`, `fecha`)
     VALUES (:pk_cantidad_ganado, :cantidad, :fk_categoria_ganado, :fk_ambiente,:fecha)";
